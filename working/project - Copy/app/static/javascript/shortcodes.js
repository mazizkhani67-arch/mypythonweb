$(document).ready(function(){
    ...
    var settings_file_browse = function (){
        var file_input = document.getElementsByClassName('profileSettingsFile')[0];
        var fake_input = document.getElementsByClassName('profileSettingsFake')[0];
        var broswe_button = document.getElementsByClassName('profileSettingsBrowse')[0];
        if(undefined!=file_input&&undefined!=fake_input&&undefined!=broswe_button){
            var click_event = document.createEvent("MouseEvents");
            var browse_function = function(){
            ...
            file_input.onchange=function(){
                ...
                fake_input.value=path;
            }
            broswe_button.onclick=browse_function;
            //fake_input.ondblclick=browse_function;
        }
    }
    settings_file_browse();
    //-shortcodes-
    //tabs
